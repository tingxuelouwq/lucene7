...
public class Syns2Index
{
            ...
            throws Throwable
    {
        ...
        try {
            ...
            IndexWriter writer = new IndexWriter(dir, new IndexWriterConfig(ana).setOpenMode(OpenMode.CREATE));
            ...
            while (i1.hasNext()) // for each word
            {
                ...
                if (n > 0)
                {
                    doc.add(new StringField(F_WORD, g, Field.Store.YES));
                    if ((++row % mod) == 0)
                    {
            ...
            throws Throwable
    {
        ...
        while (it.hasNext())
        {
            ...
            doc.add( new Field( F_SYN, cur, fieldType));
        }
        return num;
    }
