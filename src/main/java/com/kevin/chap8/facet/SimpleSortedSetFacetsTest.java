...
public class SimpleSortedSetFacetsTest {
    ...
    private List<FacetResult> search() throws IOException {
        ...
        Sort sort = new Sort(new SortField("Author", Type.INT, true));
        FacetsCollector.search(searcher, new MatchAllDocsQuery(), 10, sort, true, false, fc);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("-----------------------");
        SimpleSortedSetFacetsTest example = new SimpleSortedSetFacetsTest();
